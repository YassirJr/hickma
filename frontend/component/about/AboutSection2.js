          ...
          <div className="col-xl-6 col-lg-6 wow fadeInRight">
            <div className="tf__home_2_about_text">
              <div className="tf__heading_area tf__heading_area_left mb_25">
                ...
                <h2>Complète sur l'éducation universitaire des étudiants.</h2>
              </div>
              <p>
                Spécialisés dans la conception, la gestion et les services de soutien, nous offrons des solutions d'affaires sur mesure, fonctionnant selon le principe temporaire établi par nos soins.
              </p>

              <div className="tf__skills_bar_single">
                <div className="tipWrap d-flex">
                  <p>Thérapie Faciale</p>
